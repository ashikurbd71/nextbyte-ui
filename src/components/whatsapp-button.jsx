...
export function WhatsAppButton() {
    ...
    const handleWhatsAppClick = () => {
        const phoneNumber = '+8801718180373'; // Bangladesh country code +880 + your number
        const message = 'Hello! I would like to know more about your courses.'; // Default message
    ...
    return (
        ...
        `}>
                ...
                {/* Pulse animation */}
                <div className="absolute inset-0 rounded-full animate-ping opacity-20" style={{ background: '#25D366' }}></div>
            </button>
        </div>
    );
}
